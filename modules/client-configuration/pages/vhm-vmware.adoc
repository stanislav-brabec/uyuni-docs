...
+
----
wget --no-check-certificate https://vcenter.example.com/certs/download.zip
----
+
Replace ``vcenter.example.com`` with the fully qualified hostname for your VMWare installation.
