...
// Clients
include::modules/client-configuration/pages/clients-opensuse.adoc[leveloffset=+1]
...
include::modules/client-configuration/pages/caasp-autoinstallation-example.adoc[leveloffset=+3]
//  Client Admin Tasks
