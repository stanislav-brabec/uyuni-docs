...
include::modules/administration/pages/intro.adoc[leveloffset=+0]
// Image Management
...
// include::modules/administration/pages/public-cloud-azure.adoc[leveloffset=+2]
...
== Tuning
include::modules/administration/pages/tuning-changelogs.adoc[leveloffset=+2]
== Maintenance Window
include::modules/administration/pages/maintenance-window.adoc[leveloffset=+2]
// Rename Server
== Rename Server
include::modules/administration/pages/hostname-rename.adoc[leveloffset=+2]
// Troubleshooting
